...
from trading_moving_average import *  # Import functions from external module
from datetime import date

# Main function for running the moving average strategy Streamlit app
def run_ma_app():
    ...
    # Input: Short and long moving average window options
    ...
    if not ticker:
        ...
        if st.button("Run Analysis"):
            ...
            st.session_state.optimize_submitted = False  # Reset optimization state

        # Plot and display results if data exists
        if st.session_state.df_result is not None:
            ...
            # Optimization section: Select metric to optimize
            ...
            if submitted:
                if st.session_state.start_str is None or st.session_state.end_str is None:
                    ...
                    with st.spinner("Running optimization, please wait..."):
                        # Perform grid search to find best MA combination
